 ...
 *   entirety and paste it here, changing the prefix from theme_ to fgadmintheme_.
 *   For example:
 *
 *     original: theme_breadcrumb()
 *     theme override: fgadmintheme_breadcrumb()
 *
 *   where fgadmintheme is the name of your sub-theme. For example, the
 ...
 */
function fgadmintheme_theme(&$existing, $type, $theme, $path) {
...
function fgadmintheme_preprocess_node(&$vars, $hook) {
  ...
  // fgadmintheme_preprocess_node_page() or fgtheme_preprocess_node_story().
 ...
 */
/* -- Delete this line if you want to use this function
function fgadmintheme_preprocess_comment(&$vars, $hook) {
  $vars['sample_variable'] = t('Lorem ipsum.');
}
// */
 ...
 */
/* -- Delete this line if you want to use this function
function fgadmintheme_preprocess_block(&$vars, $hook) {
  $vars['sample_variable'] = t('Lorem ipsum.');
}
// */

function fgadmintheme_preprocess_user_register(&$vars) {
...
function fgadmintheme_user_fullname($object, $link_to_user = TRUE, $include_username = FALSE) {
	global $user;
